...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    boolean[][] onlyFalse = new boolean[3][3];
    ...
    for (boolean[] row : partiallyTrue) {
      System.out.println(Arrays.toString(row));
    }*/
    
    // testing getNeighbours
    /*System.out.println();
    System.out.println(Arrays.toString(Fingerprint.getNeighbours(onlyFalse, 1, 1)));
    System.out.println(Arrays.toString(Fingerprint.getNeighbours(onlyTrue, 1, 1)));
    System.out.println(Arrays.toString(Fingerprint.getNeighbours(partiallyTrue, 1, 1)));*/

    // testing blackNeighbours
    /*System.out.println(Fingerprint.blackNeighbours(neighboursFalse));
    System.out.println(Fingerprint.blackNeighbours(neighboursTrue));
    System.out.println(Fingerprint.blackNeighbours(neighboursPartial));*/

    // testing transitions
    /*System.out.println(Fingerprint.transitions(neighboursFalse));
    System.out.println(Fingerprint.transitions(neighboursTrue));
    System.out.println(Fingerprint.transitions(neighboursPartial));*/

    // testing identical
    /*System.out.println(Fingerprint.identical(onlyFalse, onlyTrue));
    System.out.println(Fingerprint.identical(onlyFalse, partiallyTrue));
    System.out.println(Fingerprint.identical(onlyTrue, partiallyTrue));
    ...
    testCompareAllFingerprints("1_5", 14, true);
